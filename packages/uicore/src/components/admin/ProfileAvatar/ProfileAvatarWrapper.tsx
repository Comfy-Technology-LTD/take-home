...
let styles = {
  ...
  tMedium: "flex items-center justify-center h-full w-full overflow-hidden relative [mask-image:-webkit-radial-gradient(white,black)] [-webkit-mask-image:-webkit-radial-gradient(white,black)]",
  tSmall: "",
