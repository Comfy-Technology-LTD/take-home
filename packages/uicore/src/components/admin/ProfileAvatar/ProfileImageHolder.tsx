...
export const ProfileImageHolder = ({ size, alt, src, className, aFile }: ProfileAvatarProps) => {
  ...
  return (
    <>
      <div className={"flex items-center justify-center h-full w-full overflow-hidden relative [mask-image:-webkit-radial-gradient(white,black)] [-webkit-mask-image:-webkit-radial-gradient(white,black)]"} >
